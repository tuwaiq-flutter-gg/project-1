...
print("1.Add \n2.Edit \n3.Delete \n4.view Information \n5.Search \n6.Exit");
  read(int menu ){
    ...
    case 3:{info.Delete();
    break;}
    case 4:{print(info.myListBook.join("\n"));
    break;}
    case 5:{
    break;}
    case 6:{ exit(6) ;}
    default:{print("should be a number between 1-6");
    break;}
    }
  }
...
class Info extends LibraryBook {
  List myListBook=[
  BooksRequirments(book_id: 1, book_title:"Start with why",author:"Simon Sink",price:80.0,quantity:13),
  BooksRequirments(book_id: 2, book_title:"But how do it know",author:"J. Clark Scott",price:59.9,quantity:22),
  BooksRequirments(book_id: 3, book_title:"Clean Code",author:"Robert Cecil Martin",price:50.0,quantity:5),
  BooksRequirments(book_id: 4, book_title:"Zero to One",author:"Peter Thiel",price:45.0,quantity:12),
  BooksRequirments(book_id: 5, book_title:"You don't know JS",author:"Kyle Simpson",price:39.9,quantity:9),
   ];
  ...
  bool repeatMenu1= true;
    ...
    case 1:{
      ...
      myListBook[editInput - 1] = BooksRequirments(book_title:newTitle);}
    break; }
    case 2:{ if(editMenu2 == 2){
      print("Enter the new Author:");
      String? newAuthor = stdin.readLineSync(); 
      myListBook[editInput - 1] = BooksRequirments(author:newAuthor);}
    break;}
    case 3:{ if(editMenu2 == 3){
      print("Enter the new Price:");
      int? newPrice = int.parse(stdin.readLineSync()!); 
      myListBook[editInput - 1] = BooksRequirments(price:newPrice);}
    break;}
    case 4:{ if(editMenu2 == 4){
      print("Enter the new Quantity:");
      int? newQuantity = int.parse(stdin.readLineSync()!); 
      myListBook[editInput - 1] = BooksRequirments(price:newQuantity);}
    break;}
    case 5:{ exit(5) ;}
...
class BooksRequirments{
  ...
  num? price;
  int? quantity;
 BooksRequirments ({this.book_id, this.book_title,  this.author,  this.price,  this.quantity});
